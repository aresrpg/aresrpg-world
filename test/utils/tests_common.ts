...
import { GenericTask, GenericTaskHandler } from "../../src/processing/TaskProcessing.js"
...
export const testTaskProcessing = async (tasks: GenericTask[], taskHandler: GenericTaskHandler) => {
    const env = 'MAIN'
