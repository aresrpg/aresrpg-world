...
import { PatchSides, PatchSideId, PatchOffsetId, CubeSide, CubeOffsetId, PatchBoundingPoints, CubeSides, PatchId } from './common_types.js'
...
export const getPatchNeighbours = (patchId: PatchId, patchSides = PatchSides.ALL): Vector2[] => {
...
const CubeFaces = [CubeSide.FACE_LEFT, CubeSide.FACE_RIGHT, CubeSide.FACE_BACK, CubeSide.FACE_FRONT, CubeSide.FACE_DOWN, CubeSide.FACE_UP]
