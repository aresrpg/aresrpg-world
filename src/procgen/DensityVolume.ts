...
export class DensityVolume {
    ...
    constructor(worldSeeds: WorldSeeds) {
        ...
        this.densityNoise = new NoiseSampler(densitySeed, 'densityVolume', NoiseDimension.Three)
    ...
    getBlockDensity(
        ...
        const density = this.densityNoise.rawEval(x * scaling, y * scaling, z * scaling)
