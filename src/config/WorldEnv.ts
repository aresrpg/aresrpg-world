...
import { BiomesRawConf, ItemType } from '../utils/common_types'
...
export class WorldEnv {
  ...
  getNearViewDist = () => this.rawSettings.patchViewRanges.near * this.getPatchSize()
  getFarViewDist = () => this.rawSettings.patchViewRanges.far * this.getPatchSize()
  getSeaLevel = () => this.rawSettings.biomes.seaLevel
  setSeaLevel = (seaLevel: number) => this.rawSettings.biomes.seaLevel = seaLevel
  getDistributionMapPeriod = () => this.rawSettings.distributionMapPeriod * this.getPatchSize()
...
export const worldRootEnv = new WorldEnv() //new WorldEnv()
